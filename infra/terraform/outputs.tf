...
output "aws_s3_komal_vishwakarma_14_bucket_name" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_name
  sensitive = false
}


output "aws_s3_komal_vishwakarma_14_bucket_website_endpoint" {
  value = module.appcd_551e1d2b-88ec-5406-87cf-c51521bbe894.bucket_website_endpoint
  sensitive = false
}


output "aws_s3_komal_vishwakarma_14_kms_arn" {
...
output "aws_iam_role_hello_kitty_role_komal_vishwakarma_14_arn" {
